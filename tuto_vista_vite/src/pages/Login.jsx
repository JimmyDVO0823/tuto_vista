...
const Login = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // Redirige al dashboard o la página principal de tu app
            navigate('/dashboard');
                ...
                <div className="w-full lg:w-1/2 flex items-center justify-center p-12 bg-white">
                    <div className="w-full max-w-md space-y-10">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <button
                                className="w-full signature-gradient text-white py-5 rounded-xl font-bold text-lg shadow-xl shadow-[#002045]/20 hover:-translate-y-1 transition-all disabled:opacity-50 disabled:transform-none"
                                type="submit"
                                disabled={loading}
                            >
