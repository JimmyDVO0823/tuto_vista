...
const Footer = () => {
  return (
    <footer className="mt-auto border-t border-gray-100 py-8 md:py-12 px-4 md:px-12 flex flex-col md:flex-row justify-between items-center text-[0.75rem] uppercase tracking-[0.05em] font-medium text-gray-400">
